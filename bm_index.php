    ...
    <header>
        <nav class="navbar navbar-default">
            <div class="container-fluid nav-right">
                <div class="navbar-header"><a class="navbar-brand" href="bm_select.php">一覧に戻る</a></div>
    ...
    <form method="post" action="bm_insert.php" enctype="multipart/form-data">
        <div class="jumbotron">
            ...
            <div class="inputArea">
                ...
                <label>期間：<input type="date" name="start"></label><label>～<input type="date" name="end"></label><br>
                <!-- <label>書籍URL：<input type="text" name="url"></label><br> -->
                <label>評価：<input type="number" name="rate" min="1" max="5"></label><br>
                <label class="shashin" for="image">写真：<input type="file" name="image"></label>
